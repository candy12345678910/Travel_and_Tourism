        ...
        <div className="state_bg">
            <div className='container'>
                ...
                <div className='item'>
                    ...
                    <Link><button className="state_button">
                        <div className="card border-0" style={{width: '13.5rem'}}>
                            <img className="card-img" style={{height: '22rem',width:'13.5rem', borderRadius: "10px"}} src={img2} alt="Card image cap"/>
                            <div className="card-body state_title">
                                <h5>Rajasthan</h5>
                                <p>GRAB YOUR TICKETS</p>
                            </div>
                    ...
                    <Link><button className="state_button">
                        <div className="card border-0" style={{width: '13.5rem'}}>
                            <img className="card-img" style={{height: '22rem',width:'13.5rem', borderRadius: "10px"}} src={img3} alt="Card image cap"/>
                            <div className="card-body state_title">
                    ...
                    <Link><button className="state_button">
                        <div className="card border-0" style={{width: '13.5rem'}}>
                            <img className="card-img" style={{height: '22rem',width:'13.5rem', borderRadius: "10px"}} src={img4} alt="Card image cap"/>
                            <div className="card-body state_title">
                                <h5>Punjab</h5>
                                <p>GRAB YOUR TICKETS</p>
                            </div>
                    ...
                    <Link><button className="state_button">
                        <div className="card border-0" style={{width: '13.5rem'}}>
                            <img className="card-img" style={{height: '22rem',width:'13.5rem', borderRadius: "10px"}} src={img5} alt="Card image cap"/>
                            <div className="card-body state_title">
                                <h5>Maharashtra</h5>
                                <p>GRAB YOUR TICKETS</p>
                            </div>
